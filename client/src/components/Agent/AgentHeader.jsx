    ...
    return (
        <div>
            <header className=' flex justify-between mt-1'>
                ...
                <Link to={agent ? pathname : '/agent/login'} className="flex items-center gap-2 border border-gray-300 rounded-full py-2 px-4 shadow md shadow-gray-500" >
                    {!agent && (
                    ...
                    {agent && (
                        <div className="flex  gap-1">
                            ...
                            >
                                <MenuItem  onClick={handleClose}><Link to={'/agent/chat'} className="inline-flex">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
